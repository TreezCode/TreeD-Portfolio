    ...
    >
      <group scale={0.01}>
        ...
        <mesh
          ...
          material-color={snap.items['Monitor Back Decal R'].color}
          name={'Monitor Back Decal Right'}
        ...
        <mesh
          ...
          material-color={snap.items['Monitor Front Decal'].color}
          name={'Monitor Back GigaByte'}
