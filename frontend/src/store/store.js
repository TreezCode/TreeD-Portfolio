...
export const state = proxy({
  ...
  items: {
    ...
    // textured materials
    ['Case']: { color: '', material: ['Material.074'], metalness: 1, roughness: 0 },
    ['Desk']: { color: '', material: ['Material'], metalness: 1, roughness: 0, currentTexture: [] },
    ...
    ['Powersupply']: { color: '#000', material: ['Material.074_2'], metalness: 1, roughness: 0 } ,
  },
});